...
export const metadata: Metadata = {
  ...
  description:
    'Encuentra sementales caninos en Tijuana, Baja California. Conecta con criadores verificados en la frontera. Servicio de monta sin intermediarios.',
  alternates: {
    canonical: 'https://dogstud.com/es/ciudades/tijuana',
    languages: {
      'es-MX': 'https://dogstud.com/es/ciudades/tijuana',
      'x-default': 'https://dogstud.com/es/ciudades/tijuana',
    },
  },
  openGraph: {
    title: 'Sementales en Tijuana | Servicio de Monta Baja California',
    description: 'Encuentra sementales caninos en Tijuana. Contacto directo con criadores verificados.',
    ...
    <div>
      ...
      <section style={{ backgroundColor: '#1F4D3A' }} className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-white/60 text-sm font-medium mb-3 uppercase tracking-widest">Tijuana, Baja California</p>
          <h1 className="text-4xl sm:text-5xl font-bold text-white leading-tight mb-6">
            Sementales en Tijuana
          </h1>
          <p className="text-lg text-white/70 mb-10 max-w-2xl mx-auto leading-relaxed">
            Encuentra el perro semental ideal en Tijuana y Baja California. En la frontera entre México y EE.UU.,
            accede a criadores verificados a ambos lados — sin intermediarios.
          </p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Servicio de Monta en Tijuana</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            Tijuana es una ciudad única — en la frontera entre México y California, los criadores de Baja California
            tienen acceso a una comunidad binacional de amantes de perros. En DOGSTUD encontrarás sementales de
            razas como French Bulldog, American Bully, Rottweiler, English Bulldog y más.
          </p>
          <p className="text-gray-600 leading-relaxed mb-10">
            Busca sementales en Playas de Tijuana, Zona Río, Otay y toda la región de Baja California.
            Aceptamos listados en USD o MXN. Contacto directo sin comisiones.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              { title: 'Razas Disponibles', desc: 'French Bulldog, American Bully, Rottweiler, English Bulldog, Poodle y más.' },
              { title: 'Frontera sin Barreras', desc: 'Criadores de Tijuana y San Diego en una sola plataforma. USD y MXN aceptados.' },
