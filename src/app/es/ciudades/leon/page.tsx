...
export const metadata: Metadata = {
  title: 'Sementales en León | Servicio de Monta en Guanajuato',
  description:
    'Encuentra sementales caninos en León, Guanajuato. Conecta con criadores verificados en León. Servicio de monta sin intermediarios.',
  alternates: {
    canonical: 'https://dogstud.com/es/ciudades/leon',
    languages: {
      'es-MX': 'https://dogstud.com/es/ciudades/leon',
      'x-default': 'https://dogstud.com/es/ciudades/leon',
    },
  },
  openGraph: {
    title: 'Sementales en León | Servicio de Monta en Guanajuato',
    description: 'Encuentra sementales caninos en León, Guanajuato. Contacto directo con criadores verificados.',
    ...
    <div>
      ...
      <section style={{ backgroundColor: '#1F4D3A' }} className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-white/60 text-sm font-medium mb-3 uppercase tracking-widest">León, Guanajuato</p>
          <h1 className="text-4xl sm:text-5xl font-bold text-white leading-tight mb-6">
            Sementales en León
          </h1>
          <p className="text-lg text-white/70 mb-10 max-w-2xl mx-auto leading-relaxed">
            Encuentra el perro semental ideal en León. Servicio de monta confiable en Guanajuato —
            contacto directo con criadores verificados en León de los Aldama.
          </p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Servicio de Monta en León</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            León es una ciudad en constante crecimiento con una comunidad de criadores caninos muy activa. En
            DOGSTUD puedes encontrar sementales de razas populares como French Bulldog, American Bully, Rottweiler,
            Doberman y más — con perfiles detallados y contacto directo con el dueño.
          </p>
          <p className="text-gray-600 leading-relaxed mb-10">
            Busca sementales en León centro, Ibarrilla, Valle de San Isidro o cualquier colonia del municipio.
            Conecta directamente con los criadores en Guanajuato sin comisiones ni intermediarios.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              { title: 'Razas Disponibles', desc: 'French Bulldog, American Bully, Rottweiler, Doberman, German Shepherd y más.' },
              { title: 'Contacto Directo', desc: 'Habla directamente con el criador en León. Sin intermediarios.' },
