...
export const metadata: Metadata = {
  title: 'Sementales en Mexicali | Servicio de Monta en Baja California',
  description:
    'Encuentra sementales caninos en Mexicali, Baja California. Conecta con criadores verificados en la capital bajacaliforniana. Servicio de monta sin intermediarios.',
  alternates: {
    canonical: 'https://dogstud.com/es/ciudades/mexicali',
    languages: {
      'es-MX': 'https://dogstud.com/es/ciudades/mexicali',
      'x-default': 'https://dogstud.com/es/ciudades/mexicali',
    },
  },
  openGraph: {
    title: 'Sementales en Mexicali | Servicio de Monta en Baja California',
    description: 'Encuentra sementales caninos en Mexicali. Contacto directo con criadores verificados.',
    url: 'https://dogstud.com/es/ciudades/mexicali',
  },
}

export default function MexicaliPage() {
  return (
    <div>
      {/* HERO */}
      <section style={{ backgroundColor: '#1F4D3A' }} className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-white/60 text-sm font-medium mb-3 uppercase tracking-widest">Mexicali, Baja California</p>
          <h1 className="text-4xl sm:text-5xl font-bold text-white leading-tight mb-6">
            Sementales en Mexicali
          </h1>
          <p className="text-lg text-white/70 mb-10 max-w-2xl mx-auto leading-relaxed">
            Encuentra el perro semental ideal en Mexicali. Servicio de monta confiable en Baja California —
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Servicio de Monta en Mexicali</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            Mexicali es la capital de Baja California y punto de encuentro entre criadores de México y del sur de
            California. En DOGSTUD puedes encontrar sementales de razas destacadas — American Bully, French
            Bulldog, Rottweiler, German Shepherd y más — con perfiles detallados y contacto directo.
          </p>
          <p className="text-gray-600 leading-relaxed mb-10">
            Busca sementales en Los Pinos, Progreso, Ciudad Nueva o cualquier colonia de Mexicali. Conecta
            directamente con los criadores en Baja California sin comisiones ni intermediarios.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              { title: 'Razas Disponibles', desc: 'American Bully, French Bulldog, Rottweiler, German Shepherd, Siberian Husky y más.' },
              { title: 'Contacto Directo', desc: 'Habla directamente con el criador en Mexicali. Sin intermediarios.' },
