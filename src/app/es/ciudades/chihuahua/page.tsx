...
export const metadata: Metadata = {
  title: 'Sementales en Chihuahua | Servicio de Monta en Chihuahua',
  description:
    'Encuentra sementales caninos en Chihuahua. Conecta con criadores verificados en la capital del estado más grande de México. Servicio de monta sin intermediarios.',
  alternates: {
    canonical: 'https://dogstud.com/es/ciudades/chihuahua',
    languages: {
      'es-MX': 'https://dogstud.com/es/ciudades/chihuahua',
      'x-default': 'https://dogstud.com/es/ciudades/chihuahua',
    },
  },
  openGraph: {
    title: 'Sementales en Chihuahua | Servicio de Monta en Chihuahua',
    description: 'Encuentra sementales caninos en Chihuahua. Contacto directo con criadores verificados.',
    ...
    <div>
      ...
      <section style={{ backgroundColor: '#1F4D3A' }} className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-white/60 text-sm font-medium mb-3 uppercase tracking-widest">Chihuahua, Chihuahua</p>
          <h1 className="text-4xl sm:text-5xl font-bold text-white leading-tight mb-6">
            Sementales en Chihuahua
          </h1>
          <p className="text-lg text-white/70 mb-10 max-w-2xl mx-auto leading-relaxed">
            Encuentra el perro semental ideal en Chihuahua. Servicio de monta confiable en el estado más grande
            de México — contacto directo con criadores verificados en la capital chihuahuense.
          </p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Servicio de Monta en Chihuahua</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            Chihuahua concentra una comunidad de criadores caninos con larga tradición en el norte de México.
            En DOGSTUD puedes encontrar sementales de razas populares — American Bully, Rottweiler, German
            Shepherd, Doberman, French Bulldog y más — con perfiles detallados y contacto directo.
          </p>
          <p className="text-gray-600 leading-relaxed mb-10">
            Busca sementales en Delicias, Cuauhtémoc, El Saucito o cualquier colonia de la ciudad de Chihuahua.
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              ...
              { title: 'Contacto Directo', desc: 'Habla directamente con el criador en Chihuahua. Sin intermediarios.' },
