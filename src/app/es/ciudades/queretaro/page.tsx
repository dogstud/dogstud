...
export const metadata: Metadata = {
  title: 'Sementales en Querétaro | Servicio de Monta en Querétaro',
  description:
    'Encuentra sementales caninos en Querétaro. Conecta con criadores verificados en Santiago de Querétaro. Servicio de monta sin intermediarios.',
  alternates: {
    canonical: 'https://dogstud.com/es/ciudades/queretaro',
    languages: {
      'es-MX': 'https://dogstud.com/es/ciudades/queretaro',
      'x-default': 'https://dogstud.com/es/ciudades/queretaro',
    },
  },
  openGraph: {
    title: 'Sementales en Querétaro | Servicio de Monta en Querétaro',
    description: 'Encuentra sementales caninos en Querétaro. Contacto directo con criadores verificados.',
    ...
    <div>
      ...
      <section style={{ backgroundColor: '#1F4D3A' }} className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-white/60 text-sm font-medium mb-3 uppercase tracking-widest">Querétaro, Querétaro</p>
          <h1 className="text-4xl sm:text-5xl font-bold text-white leading-tight mb-6">
            Sementales en Querétaro
          </h1>
          <p className="text-lg text-white/70 mb-10 max-w-2xl mx-auto leading-relaxed">
            Encuentra el perro semental ideal en Querétaro. Servicio de monta confiable en Santiago de Querétaro —
            contacto directo con criadores verificados en el estado de Querétaro.
          </p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Servicio de Monta en Querétaro</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            Querétaro es una de las ciudades de más rápido crecimiento en México y cuenta con una sólida comunidad
            de criadores caninos. En DOGSTUD puedes encontrar sementales de razas destacadas — French Bulldog,
            Rottweiler, American Bully, Cane Corso, German Shepherd y más.
          </p>
          <p className="text-gray-600 leading-relaxed mb-10">
            Busca sementales en El Marqués, Corregidora, San Juan del Río o el centro histórico de Querétaro.
            Conecta directamente con los criadores sin comisiones ni intermediarios.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              { title: 'Razas Disponibles', desc: 'French Bulldog, Rottweiler, American Bully, Cane Corso, German Shepherd y más.' },
              { title: 'Contacto Directo', desc: 'Habla directamente con el criador en Querétaro. Sin intermediarios.' },
